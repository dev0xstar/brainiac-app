...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [38642],
  {
    38642: function (e, a, t) {
      t.d(a, {
        PasskeyWebClient: function () {
          return H;
        },
        J: function () {
          return R;
      ...
      var c = Object.defineProperty,
        i = (e, a) => {
          for (var t in a) c(e, t, { get: a[t], enumerable: !0 });
        },
        r = {};
      function n() {
      ...
      function b(e) {
        return null !== e.match(/^[a-zA-Z0-9\-_]+=*$/);
      }
      function f(e) {
        return btoa(o(e)).replaceAll("+", "-").replaceAll("/", "_");
      }
      function u(e) {
        return d(atob((e = e.replaceAll("-", "+").replaceAll("_", "/"))));
      }
      async function s(e) {
      ...
      function h(e, a) {
        ...
        return (
          t.set(new Uint8Array(e), 0), t.set(new Uint8Array(a), e.byteLength), t
        );
      }
      function y() {
      ...
      async function g(e) {
        if ("local" === e) return "platform";
        if ("roaming" === e || "extern" === e) return "cross-platform";
        if ("both" !== e)
          try {
            return (await D()) ? "platform" : "cross-platform";
          } catch {
            return;
          }
      }
      async function A(e, a, t) {
        ...
        let c = {
          challenge: u(a),
          rp: {
            id: t.domain ?? window.location.hostname,
            name: t.domain ?? window.location.hostname,
          },
          user: {
            id: t.userHandle
              ? d(t.userHandle)
              : await s(new TextEncoder().encode("passwordless.id-user:" + e)),
            name: e,
            displayName: e,
          },
          pubKeyCredParams: [
          ...
          authenticatorSelection: {
            ...
            authenticatorAttachment: await g(t.authenticatorType ?? "auto"),
            residentKey: t.discoverable ?? "preferred",
            requireResidentKey: "required" === t.discoverable,
          },
          attestation: "direct",
        };
              ...
              algorithm: (function (e) {
                switch (e) {
                  ...
                  case -257:
                    return "RS256";
                  default:
                    throw Error(`Unknown algorithm code: ${e}`);
                }
              })(i.response.getPublicKeyAlgorithm()),
            },
            authenticatorData: f(r.getAuthenticatorData()),
            clientData: f(r.clientDataJSON),
          };
        return t.attestation && (n.attestationData = f(r.attestationObject)), n;
      }
      async function I(e) {
        let a = ["internal"],
          t = ["hybrid", "usb", "ble", "nfc"];
        if ("local" === e) return a;
        if ("roaming" == e || "extern" === e) return t;
        if ("both" === e) return [...a, ...t];
        try {
          return (await D()) ? a : t;
        } catch {
          return [...a, ...t];
      ...
      async function p(e, a, t) {
        ...
        let c = await I(t.authenticatorType ?? "auto"),
          i = {
            challenge: u(a),
            rpId: t.domain ?? window.location.hostname,
        ...
        t.debug && console.debug(i);
        let r = await navigator.credentials.get({
          publicKey: i,
        ...
        return {
          credentialId: r.id,
          authenticatorData: f(n.authenticatorData),
          clientData: f(n.clientDataJSON),
          signature: f(n.signature),
          userHandle: n.userHandle ? f(n.userHandle) : void 0,
        };
      }
      i(r, {
        authenticate: () => p,
        isAvailable: () => y,
        isLocalAuthenticator: () => D,
        register: () => A,
      }),
        i(
          {},
        ...
        i(
          ...
          {
            parseAttestation: () => C,
            parseAuthentication: () => K,
            parseAuthenticator: () => w,
            parseClient: () => O,
            parseRegistration: () => m,
          }
        );
      var S = {
          ...
          "3e22415d-7fdf-4ea4-8a0c-dd60c4249b9d":
            "Feitian iePass FIDO Authenticator",
          ...
          "c5ef55ff-ad9a-4b9f-b580-adebafe026d0":
            "YubiKey 5 Series with Lightning",
          ...
          "d94a29d9-52dd-4247-9c2d-8b818b610389":
            "VeriMark Guard Fingerprint Key",
      ...
      function O(e) {
        return "string" == typeof e && (e = u(e)), JSON.parse(F.decode(e));
      }
      function w(e) {
        return (
          ...
          (function (e) {
            let a = new DataView(e.slice(32, 33)).getUint8(0),
              t = {
                rpIdHash: f(e.slice(0, 32)),
                flags: {
                  userPresent: !!(1 & a),
                  userVerified: !!(4 & a),
                  backupEligibility: !!(8 & a),
                  backupState: !!(16 & a),
                  attestedData: !!(64 & a),
                  extensionsIncluded: !!(128 & a),
                },
            ...
            if (((t.synced = t.flags.backupState), e.byteLength > 37)) {
              let a;
              let c =
                (a = l(e.slice(37, 53))).substring(0, 8) +
                "-" +
                a.substring(8, 12) +
                "-" +
                a.substring(12, 16) +
      ...
      function m(e) {
        return {
          ...
          client: O(e.clientData),
          authenticator: w(e.authenticatorData),
          attestation: e.attestationData ? e.attestationData : null,
        };
      }
      function K(e) {
        return {
      ...
      async function E(e, a) {
        let t = m(e);
        if ("webauthn.create" !== t.client.type)
          throw Error(`Unexpected ClientData type: ${t.client.type}`);
        if (await T(a.origin, t.client.origin))
          throw Error(`Unexpected ClientData origin: ${t.client.origin}`);
        if (await T(a.challenge, t.client.challenge))
          throw Error(`Unexpected ClientData challenge: ${t.client.challenge}`);
        return t;
      }
      async function N(e, a, t) {
        if (e.credentialId !== a.id)
          throw Error(`Credential ID mismatch: ${e.credentialId} vs ${a.id}`);
        if (
          !(await v({
          ...
          throw Error(`Invalid signature: ${e.signature}`);
        let c = K(e);
        if ((t.verbose && console.debug(c), "webauthn.get" !== c.client.type))
          throw Error(`Unexpected clientData type: ${c.client.type}`);
        if (await T(t.origin, c.client.origin))
          throw Error(`Unexpected ClientData origin: ${c.client.origin}`);
        if (await T(t.challenge, c.client.challenge))
          throw Error(`Unexpected ClientData challenge: ${c.client.challenge}`);
        let i = t.domain ?? new URL(c.client.origin).hostname,
          r = f(await s(d(i)));
        if (c.authenticator.rpIdHash !== r)
          throw Error(
            `Unexpected RpIdHash: ${c.authenticator.rpIdHash} vs ${r}`
          );
        if (!c.authenticator.flags.userPresent)
          throw Error("Unexpected authenticator flags: missing userPresent");
        if (!c.authenticator.flags.userVerified && t.userVerified)
          throw Error("Unexpected authenticator flags: missing userVerified");
        if (t.counter && c.authenticator.counter <= t.counter)
          throw Error(
            `Unexpected authenticator counter: ${c.authenticator.counter} (should be > ${t.counter})`
          );
        return c;
      }
      ...
      async function v({
        ...
        let I = await s(u(c)),
          p = h(u(t), I);
        r &&
          (console.debug("Crypto Algo: " + JSON.stringify(g)),
          console.debug("Public key: " + a),
          console.debug("Data: " + f(p)),
          console.debug("Signature: " + i));
        let S = u(i);
        return (
          "ES256" == e &&
            ((n = S),
            (b = (o = 0 === (d = new Uint8Array(n))[4] ? 5 : 4) + 32),
            (l = 0 === d[b + 2] ? b + 3 : b + 2),
            (y = d.slice(o, b)),
            (D = d.slice(l)),
            (S = new Uint8Array([...y, ...D]))),
          await crypto.subtle.verify(g, A, S, p)
        );
      }
      var B = t(28933),
        x = t(54507),
      ...
      class H {
        ...
        async register(e) {
          let { name: a, challenge: t, rp: c } = e,
            i = await r.register(a, t, {
            ...
            n = (0, x.Df)(i.clientData),
            d = JSON.parse((0, x.Vy)(n));
          return {
            authenticatorData: i.authenticatorData,
            credentialId: i.credential.id,
            clientData: i.clientData,
            credential: {
              publicKey: i.credential.publicKey,
              algorithm: i.credential.algorithm,
            },
            origin: d.origin,
          };
        }
        async authenticate(e) {
          let { credentialId: a, challenge: t, rp: c } = e,
            i = await r.authenticate(a ? [a] : [], t, {
              authenticatorType: "auto",
              userVerification: "required",
              domain: c.id,
            }),
      ...
      async function R(e, a) {
        let t = new k.A({ storage: B.x, clientId: e.clientId, ecosystemId: a });
        return !!(await t.getPasskeyCredentialId());
      }
    },
  },
]);
