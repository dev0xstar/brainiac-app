...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [93484],
  {
    21236: function (t, e, r) {
      ...
      var P = Object.defineProperty,
        ...
        F = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        L = (t, e) => {
          for (var r in e || (e = {})) D.call(e, r) && F(t, r, e[r]);
          if (U) for (var r of U(e)) T.call(e, r) && F(t, r, e[r]);
          return t;
        };
      let q = {
      ...
      function H() {
        return !z() && !!(0, A.getNavigator)() && !!(0, A.getDocument)();
      }
      function K() {
        return j() ? q.reactNative : z() ? q.node : H() ? q.browser : q.unknown;
      }
      function Q() {
        var t;
        try {
      ...
      async function tu({ id: t, topic: e, wcDeepLink: i }) {
        var n;
        try {
          if (!i) return;
      ...
      async function tf(t, e) {
        try {
          return (
            (await t.getItem(e)) || (H() ? localStorage.getItem(e) : void 0)
          );
        } catch (t) {
          console.error(t);
        }
      ...
      let tp = !1,
        tm = !1,
        tg = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 },
        tv = 2,
        tA = null,
        ty = (function () {
          try {
      ...
      class tw {
        ...
        _log(t, e) {
          ...
          null == tg[r] &&
            ...
            tv > tg[r] || console.log.apply(console, e);
        }
        debug(...t) {
        ...
        checkNormalize(t) {
          ty &&
            this.throwError(
              ...
              tw.errors.UNSUPPORTED_OPERATION,
              { operation: "String.prototype.normalize", form: ty }
            );
        }
        checkSafeUint53(t, e) {
          "number" == typeof t &&
            ...
            (t < 0 || t >= 9007199254740991) &&
              this.throwError(e, tw.errors.NUMERIC_FAULT, {
        ...
        checkArgumentCount(t, e, r) {
          (r = r ? ": " + r : ""),
            t < e &&
              this.throwError(
                "missing argument" + r,
                tw.errors.MISSING_ARGUMENT,
                { count: t, expectedCount: e }
              ),
            t > e &&
              this.throwError(
                "too many arguments" + r,
                tw.errors.UNEXPECTED_ARGUMENT,
                { count: t, expectedCount: e }
              );
        }
        checkNew(t, e) {
          (t === Object || null == t) &&
            this.throwError("missing new", tw.errors.MISSING_NEW, {
              name: e.name,
            });
        }
        checkAbstract(t, e) {
      ...
      function tB(t, e) {
        ...
        if (
          ...
          r.length % 2 &&
            ("left" === e.hexPad
              ...
              : "right" === e.hexPad
              ? (r += "0")
              : tM.throwArgumentError("hex data is odd-length", "value", t));
          let i = [];
        ...
        return tN(t)
          ? tS(new Uint8Array(t))
          : tM.throwArgumentError("invalid arrayify value", "value", t);
      }
      function tx(t, e) {
        return !(
          "string" != typeof t ||
      ...
      function tO(t, e, r) {
        return (
          "string" != typeof t
            ? (t = t_(t))
            : (!tx(t) || t.length % 2) &&
              tM.throwArgumentError("invalid hexData", "value", t),
          (e = 2 + 2 * e),
      ...
      function tR(t, e) {
        for (
          "string" != typeof t
            ? (t = t_(t))
            : tx(t) || tM.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
              tM.throwArgumentError(
                "value out of range",
                "value",
                arguments[1]
              );
        ...
        if ((tx(t) && !(t.length % 2)) || tN(t)) {
          ...
          64 === r.length
            ? ((e.v = 27 + (r[32] >> 7)),
              (r[32] &= 127),
              (e.r = t_(r.slice(0, 32))),
              (e.s = t_(r.slice(32, 64))))
            : 65 === r.length
            ? ((e.r = t_(r.slice(0, 32))),
              (e.s = t_(r.slice(32, 64))),
              (e.v = r[64]))
            : tM.throwArgumentError("invalid signature string", "signature", t),
            e.v < 27 &&
              (0 === e.v || 1 === e.v
                ? (e.v += 27)
                : tM.throwArgumentError(
          ...
          let r = tB(e.s);
          r[0] >= 128 &&
            tM.throwArgumentError("signature s out of range", "signature", t),
            e.recoveryParam && (r[0] |= 128);
          let i = t_(r);
          e._vs &&
            (tx(e._vs) ||
              tM.throwArgumentError("signature invalid _vs", "signature", t),
            (e._vs = tR(e._vs, 32))),
            null == e._vs
              ? (e._vs = i)
              : e._vs !== i &&
      ...
      !(function (t, e) {
        ...
        var m = function (t, e, r) {
          ...
          (h = (((o + (n >>> 13)) | 0) + (tE >>> 26)) | 0),
            (tE &= 67108863),
            (i = Math.imul(U, z)),
            (n = ((n = Math.imul(U, j)) + Math.imul(D, z)) | 0),
            (o = Math.imul(D, j)),
            (i = (i + Math.imul(R, K)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tS >>> 26)) | 0),
            ...
            (o = Math.imul(L, j)),
            (i = (i + Math.imul(U, K)) | 0),
            (n = ((n = (n + Math.imul(U, Q)) | 0) + Math.imul(D, K)) | 0),
            (o = (o + Math.imul(D, Q)) | 0),
            (i = (i + Math.imul(R, G)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tI >>> 26)) | 0),
            ...
            (o = Math.imul(L, Q)),
            (i = (i + Math.imul(U, G)) | 0),
            (n = ((n = (n + Math.imul(U, Y)) | 0) + Math.imul(D, G)) | 0),
            (o = (o + Math.imul(D, Y)) | 0),
            (i = (i + Math.imul(R, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tN >>> 26)) | 0),
            ...
            (o = Math.imul(L, Y)),
            (i = (i + Math.imul(U, W)) | 0),
            (n = ((n = (n + Math.imul(U, X)) | 0) + Math.imul(D, W)) | 0),
            (o = (o + Math.imul(D, X)) | 0),
            (i = (i + Math.imul(R, $)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tB >>> 26)) | 0),
            ...
            (o = Math.imul(L, X)),
            (i = (i + Math.imul(U, $)) | 0),
            (n = ((n = (n + Math.imul(U, tt)) | 0) + Math.imul(D, $)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tx >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(U, ti)) | 0) + Math.imul(D, tr)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tC >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(U, ts)) | 0) + Math.imul(D, to)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (t_ >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(U, th)) | 0) + Math.imul(D, tf)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tO >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(U, tc)) | 0) + Math.imul(D, tl)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tR >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(U, tm)) | 0) + Math.imul(D, tp)) | 0),
      ...
      class tH {
        ...
        div(t) {
          return (
            tH.from(t).isZero() && tG("division-by-zero", "div"),
            tQ(tJ(this).div(tJ(t)))
          );
        }
        mul(t) {
        ...
        mod(t) {
          let e = tJ(t);
          return (
            e.isNeg() && tG("division-by-zero", "mod"), tQ(tJ(this).umod(e))
          );
        }
        pow(t) {
          let e = tJ(t);
        ...
        xor(t) {
          ...
          return (
            (this.isNegative() || e.isNeg()) &&
              tG("unbound-bitwise-result", "xor"),
            tQ(tJ(this).xor(e))
          );
        }
        mask(t) {
          return (
            (this.isNegative() || t < 0) && tG("negative-width", "mask"),
            tQ(tJ(this).maskn(t))
          );
        }
        shl(t) {
          return (
            (this.isNegative() || t < 0) && tG("negative-width", "shl"),
            tQ(tJ(this).shln(t))
          );
        }
        shr(t) {
          return (
            (this.isNegative() || t < 0) && tG("negative-width", "shr"),
            tQ(tJ(this).shrn(t))
          );
        }
        eq(t) {
        ...
        static from(t) {
          ...
          if ("string" == typeof t)
            return t.match(/^-?0x[0-9a-f]+$/i)
              ? new tH(tz, tK(t))
              : t.match(/^-?[0-9]+$/)
              ? new tH(tz, tK(new tL(t)))
              : tq.throwArgumentError("invalid BigNumber string", "value", t);
          if ("number" == typeof t)
            return (
              t % 1 && tG("underflow", "BigNumber.from", t),
              (t >= 9007199254740991 || t <= -9007199254740991) &&
                tG("overflow", "BigNumber.from", t),
              tH.from(String(t))
            );
      ...
      function tK(t) {
        ...
        if ("-" === t[0])
          return (
            "-" === (t = t.substring(1))[0] &&
              tq.throwArgumentError("invalid hex", "value", t),
            "0x00" === (t = tK(t)) ? t : "-" + t
          );
      ...
      function tJ(t) {
        ...
        return "-" === e[0]
          ? new tL("-" + e.substring(3), 16)
          : new tL(e.substring(2), 16);
      }
      function tG(t, e, r) {
        let i = { fault: t, operation: e };
        return (
          null != r && (i.value = r),
          tq.throwError(t, tw.errors.NUMERIC_FAULT, i)
        );
      }
      let tY = new tw(tF),
        tV = {},
      ...
      function tZ(t, e, r, i) {
        ...
        return (
          void 0 !== i && (n.value = i),
          tY.throwError(t, tw.errors.NUMERIC_FAULT, n)
        );
      }
      let t$ = "0";
      ...
      function t0(t) {
        ...
        return "number" == typeof t && t >= 0 && t <= 256 && !(t % 1)
          ? "1" + t$.substring(0, t)
          : tY.throwArgumentError("invalid decimal size", "decimals", t);
      }
      function t1(t, e) {
        null == e && (e = 0);
        let r = t0(e),
      ...
      function t2(t, e) {
        ...
        ("string" == typeof t && t.match(/^-?[0-9.]+$/)) ||
          tY.throwArgumentError("invalid decimal value", "value", t);
        let i = "-" === t.substring(0, 1);
        i && (t = t.substring(1)),
          "." === t && tY.throwArgumentError("missing value", "value", t);
        let n = t.split(".");
        n.length > 2 &&
          tY.throwArgumentError("too many decimal points", "value", t);
        let o = n[0],
          s = n[1];
          ...
          if ("string" == typeof t) {
            if ("fixed" !== t) {
              if ("ufixed" === t) e = !1;
                ...
                n || tY.throwArgumentError("invalid fixed format", "format", t),
                  (e = "u" !== n[1]),
                  (r = parseInt(n[2])),
                  (i = parseInt(n[3]));
              }
      ...
      class t6 {
        ...
        floor() {
          ...
          let e = t6.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (e = e.subUnsafe(t8.toFormat(e.format))),
            e
          );
        }
        ceiling() {
          ...
          let e = t6.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (e = e.addUnsafe(t8.toFormat(e.format))),
            e
          );
        }
        round(t) {
          ...
          if (
            (1 === e.length && e.push("0"),
            (t < 0 || t > 80 || t % 1) &&
              tY.throwArgumentError("invalid decimal count", "decimals", t),
            e[1].length <= t)
          )
            return this;
        ...
        toHexString(t) {
          return null == t
            ? this._hex
            : (t % 8 && tY.throwArgumentError("invalid byte width", "width", t),
              tR(
                tH
                  .from(this._hex)
        ...
        static fromValue(t, e, r) {
          ...
          return (
            ...
            null == e && (e = 0),
            null == r && (r = "fixed"),
            t6.fromString(t1(t, e), t3.from(r))
          );
        }
        static fromString(t, e) {
          ...
          !r.signed &&
            i.lt(tW) &&
            tZ("unsigned value cannot be negative", "overflow", "value", t);
          let n = null;
          return new t6(
            tV,
            r.signed
              ? i.toTwos(r.width).toHexString()
              : tR(i.toHexString(), r.width / 8),
            t1(i, r.decimals),
            r
          );
        }
...
`;
      function eh(t) {
        return (
          "string" == typeof t && (t = t9(t)),
          tP(
            (function (t) {
              let e = t.map((t) => tB(t)),
                r = e.reduce((t, e) => t + e.length, 0),
                i = new Uint8Array(r);
              return e.reduce((t, e) => (i.set(e, t), t + e.length), 0), tS(i);
      ...
      for (let t = 0; t < 26; t++)
        ec[String.fromCharCode(65 + t)] = String(10 + t);
      let ed = Math.floor(
        Math.log10
      ...
      tH.from(
        ...
        tR(eg.toHexString(), 32),
        tR(em.toHexString(), 32);
      var ev = {},
        eA = {};
      function ey(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      ...
      (eI.BlockHash = eN),
        (eN.prototype.update = function (t, e) {
          if (
            ((t = eA.toArray(t, e)),
            this.pending
            ...
            (this.pending = t.slice(t.length - r, t.length)),
              ...
              (t = eA.join32(t, 0, t.length - r, this.endian));
        ...
        (eN.prototype.digest = function (t) {
          return (
            this.update(this._pad()), ey(null === this.pending), this._digest(t)
          );
        }),
      ...
      eA.inherits(eT, eU),
        ...
        (eT.hmacStrength = 80),
        (eT.padLength = 64),
        (eT.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = eO(r[i - 3] ^ r[i - 8] ^ r[i - 14] ^ r[i - 16], 1);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            u = this.h[3],
          ...
          (this.h[0] = eR(this.h[0], n)),
            (this.h[1] = eR(this.h[1], o)),
            (this.h[2] = eR(this.h[2], s)),
            (this.h[3] = eR(this.h[3], u)),
            (this.h[4] = eR(this.h[4], f));
        }),
        (eT.prototype._digest = function (t) {
          return "hex" === t
            ? eA.toHex32(this.h, "big")
      ...
      eA.inherits(eV, eG),
        ...
        (eV.hmacStrength = 192),
        (eV.padLength = 64),
        (eV.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = eL(eJ(r[i - 2]), r[i - 7], eQ(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            u = this.h[3],
          ...
          (this.h[0] = eF(this.h[0], n)),
            (this.h[1] = eF(this.h[1], o)),
            (this.h[2] = eF(this.h[2], s)),
            (this.h[3] = eF(this.h[3], u)),
            (this.h[4] = eF(this.h[4], f)),
            (this.h[5] = eF(this.h[5], h)),
            (this.h[6] = eF(this.h[6], a)),
            (this.h[7] = eF(this.h[7], l));
        }),
        ...
        (eW.prototype._digest = function (t) {
          return "hex" === t
            ? eA.toHex32(this.h.slice(0, 7), "big")
            : eA.split32(this.h.slice(0, 7), "big");
        });
      var eX = eA.rotr64_hi,
        eZ = eA.rotr64_lo,
        e$ = eA.shr64_hi,
      ...
      eA.inherits(rt, e7),
        ...
        (rt.hmacStrength = 192),
        (rt.padLength = 128),
        (rt.prototype._prepareBlock = function (t, e) {
          ...
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
              ...
              a = r[i - 32],
              l = r[i - 31];
            (r[i] = e6(n, o, s, u, f, h, a, l)),
              (r[i + 1] = e8(n, o, s, u, f, h, a, l));
          }
        }),
        ...
        (re.prototype._digest = function (t) {
          return "hex" === t
            ? eA.toHex32(this.h.slice(0, 12), "big")
            : eA.split32(this.h.slice(0, 12), "big");
        }),
        (eB.sha1 = eT),
        (eB.sha224 = eW),
        (eB.sha256 = eV),
      ...
      eA.inherits(rf, ru),
        ...
        (rf.prototype._update = function (t, e) {
          ...
          (m = ro(this.h[1], n, a)),
            (this.h[1] = ro(this.h[2], o, l)),
            (this.h[2] = ro(this.h[3], s, u)),
            (this.h[3] = ro(this.h[4], r, f)),
            (this.h[4] = ro(this.h[0], i, h)),
            (this.h[0] = m);
        }),
        (rf.prototype._digest = function (t) {
          return "hex" === t
            ? eA.toHex32(this.h, "little")
            : eA.split32(this.h, "little");
        });
      var ra = [
      ...
      (rp.prototype._init = function (t) {
        ...
        (ev.hmac = rp),
        (ev.sha1 = ev.sha.sha1),
        (ev.sha256 = ev.sha.sha256),
        (ev.sha224 = ev.sha.sha224),
        (ev.sha384 = ev.sha.sha384),
        (ev.sha512 = ev.sha.sha512),
        (ev.ripemd160 = ev.ripemd.ripemd160);
      var rg = rv;
      function rv(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      }
        ...
        (rE.prototype._wnafMulAdd = function (t, e, r, i, n) {
          ...
          for (o = i - 1; o >= 1; o -= 2) {
            var d = o - 1,
              p = o;
            if (1 !== f[d] || 1 !== f[p]) {
              (a[d] = rb(r[d], f[d], this._bitLength)),
                (a[p] = rb(r[p], f[p], this._bitLength)),
      ...
      function rx(t, e, r, i) {
        rE.BasePoint.call(this, t, "affine"),
          null === e && null === r
      ...
      function rC(t, e, r, i) {
        rE.BasePoint.call(this, t, "jacobian"),
      ...
      rI(rB, rE),
        (rB.prototype._getEndomorphism = function (t) {
          if (!(!this.zeroA || !this.g || !this.n || 1 !== this.p.modn(3))) {
            ...
            if (t.lambda) r = new tT(t.lambda, 16);
              ...
              0 === this.g.mul(o[0]).x.cmp(this.g.x.redMul(e))
                ? (r = o[0])
                : ((r = o[1]),
                  rN(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
            }
            return (
              (i = t.basis
                ? t.basis.map(function (t) {
                    return { a: new tT(t.a, 16), b: new tT(t.b, 16) };
                  })
        ...
        rI(rx, rE.BasePoint),
        (rB.prototype.point = function (t, e, r) {
        ...
        rI(rC, rE.BasePoint),
        (rB.prototype.jpoint = function (t, e, r) {
      ...
      var r_ = rm(function (t, e) {
        ...
        rO = rm(function (t, e) {
          ...
          function n(t) {
            "short" === t.type
              ? (this.curve = new r_.short(t))
              : "edwards" === t.type
              ? (this.curve = new r_.edwards(t))
              : (this.curve = new r_.mont(t)),
              (this.g = this.curve.g),
              (this.n = this.curve.n),
              (this.hash = t.hash),
      ...
      (rR.prototype._init = function (t, e, r) {
        ...
        (rR.prototype.generate = function (t, e, r, i) {
          ...
          "string" != typeof e && ((i = r), (r = e), (e = null)),
            r && ((r = rA.toArray(r, i || "hex")), this._update(r));
      ...
      (rP.fromPublic = function (t, e, r) {
        return e instanceof rP ? e : new rP(t, { pub: e, pubEnc: r });
      }),
        (rP.fromPrivate = function (t, e, r) {
          return e instanceof rP ? e : new rP(t, { priv: e, privEnc: r });
        }),
        ...
        (rP.prototype._importPublic = function (t, e) {
          if (t.x || t.y) {
            "mont" === this.ec.curve.type
              ? rk(t.x, "Need x coordinate")
              : ("short" === this.ec.curve.type ||
                  "edwards" === this.ec.curve.type) &&
                rk(t.x && t.y, "Need both x and y coordinate"),
        ...
        (rP.prototype.derive = function (t) {
          return (
            t.validate() || rk(t.validate(), "public point not validated"),
      ...
      function rD(t, e) {
        ...
        this._importDER(t, e) ||
          (rU(t.r && t.s, "Signature without r or s"),
      ...
      function rH(t) {
        ...
        "string" == typeof t &&
          (rj(
            Object.prototype.hasOwnProperty.call(rO, t),
            "Unknown curve " + t
          ),
          (t = rO[t])),
          t instanceof rO.PresetCurve && (t = { curve: t }),
                  ...
                  if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                    ...
                    return (
                      i.canonical &&
                        p.cmp(this.nh) > 0 &&
                        ((p = this.n.sub(p)), (m ^= 1)),
                      new rD({ r: d, s: p, recoveryParam: m })
                    );
                  }
                }
              }
      ...
      class rY {
        constructor(t) {
          ep(this, "curve", "secp256k1"),
            ep(this, "privateKey", t_(t)),
            32 !==
              (function (t) {
              ...
              rQ.throwArgumentError(
                "invalid private key",
                "privateKey",
                "[[ REDACTED ]]"
              );
          let e = rG().keyFromPrivate(tB(this.privateKey));
          ep(this, "publicKey", "0x" + e.getPublic(!1, "hex")),
            ep(this, "compressedPublicKey", "0x" + e.getPublic(!0, "hex")),
            ep(this, "_isSigningKey", !0);
        }
        _addPoint(t) {
        ...
        signDigest(t) {
          let e = rG().keyFromPrivate(tB(this.privateKey)),
            r = tB(t);
          32 !== r.length &&
            rQ.throwArgumentError("bad digest length", "digest", t);
      ...
      function rV(t, e) {
        ...
        if (32 === r.length) {
          let t = new rY(r);
          return e
            ? "0x" + rG().keyFromPrivate(r).getPublic(!0, "hex")
            : t.publicKey;
        }
        return 33 === r.length
          ? e
            ? t_(r)
            : "0x" + rG().keyFromPublic(r).getPublic(!1, "hex")
          : 65 === r.length
          ? e
            ? "0x" + rG().keyFromPublic(r).getPublic(!0, "hex")
            : t_(r)
          : rQ.throwArgumentError(
          ...
          case "eip191":
            ...
            return (
              ...
              (function (t) {
                ...
                if (
                  ("string" != typeof t &&
                    ea.throwArgumentError("invalid address", "address", t),
                  ...
                  for (
                    t.substring(2, 4) !==
                      ...
                      ea.throwArgumentError("bad icap checksum", "address", t),
                      e = new tL(t.substring(4), 36).toString(16);
                    e.length < 40;
                      ...
                      rV(
                        (function (t, e) {
                          ...
                          return (
                            "0x" +
                            rG()
                              .recoverPubKey(tB(t), i, r.recoveryParam)
                              .encode("hex", !1)
                          );
                        })(tB(eh(e)), s)
                      ),
      ...
      async function rX(t, e, r, i, n, o) {
        try {
          let s = "0x1626ba7e",
            ...
            h = await fetch(
              `${
                o || "https://rpc.walletconnect.com/v1"
      ...
      var rZ = Object.defineProperty,
        ...
        r8 = (t, e) => {
          ...
          if (r1) for (var r of r1(e)) r3.call(e, r) && r6(t, r, e[r]);
          return t;
        },
        r4 = (t, e) => r$(t, r0(e));
      let r5 = (t) => t?.split(":"),
...
`)
      ...
      function iB(t) {
        let e = iI("u" > typeof t.type ? t.type : 0);
        if (iN(e) === iA && typeof t.senderPublicKey > "u")
          throw Error("Missing sender public key for type 1 envelope");
        let r =
            "u" > typeof t.senderPublicKey
              ? (0, N.mL)(t.senderPublicKey, ip)
              : void 0,
          i = "u" > typeof t.iv ? (0, N.mL)(t.iv, ip) : (0, E.randomBytes)(12);
        return iO({
          type: e,
          sealed: new w.OK((0, N.mL)(t.symKey, ip)).seal(
            i,
            (0, N.mL)(t.message, iv)
          ),
          iv: i,
      ...
      function ix(t, e) {
        ...
        return iO({ type: r, sealed: (0, N.mL)(t, iv), iv: i, encoding: e });
      }
      function iC(t) {
      ...
      function i_(t, e) {
        let { sealed: r } = iR({ encoded: t, encoding: e });
        return (0, N.BB)(r, iv);
      }
      function iO(t) {
        let { encoding: e = im } = t;
      ...
      function ik(t, e) {
        let r = iR({ encoded: t, encoding: e?.encoding });
        return iP({
          type: iN(r.type),
          senderPublicKey:
            "u" > typeof r.senderPublicKey
              ? (0, N.BB)(r.senderPublicKey, ip)
              : void 0,
      ...
      var iq = Object.defineProperty,
        ...
        iJ = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        iG = (t, e) => {
          for (var r in e || (e = {})) iK.call(e, r) && iJ(t, r, e[r]);
          if (iH) for (var r of iH(e)) iQ.call(e, r) && iJ(t, r, e[r]);
          return t;
        },
        iY = (t, e) => iz(t, ij(e));
      function iV(t) {
      ...
      function i1(t, e) {
        ...
        for (let [e, i] of Object.entries(r))
          i.methods ? (i.methods = ts(i.methods, t)) : (i.methods = t),
      ...
      function i6(t, e) {
        let { message: r, code: i } = i3[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function i8(t, e) {
        let { message: r, code: i } = i2[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function i4(t, e) {
        return (
      ...
      function i9(t, e) {
        return !!(e && i7(t)) || ("string" == typeof t && !!t.trim().length);
      }
      function nt(t, e) {
        return !!(e && i7(t)) || ("number" == typeof t && !isNaN(t));
      }
      function ne(t, e) {
        ...
        return (
          ...
          (i.forEach((e) => {
            let { accounts: i, methods: n, events: s } = t.namespaces[e],
              u = iZ(i),
              f = r[e];
            (Y(k(e, f), u) && Y(f.methods, n) && Y(f.events, s)) || (o = !1);
          }),
          o)
        );
      }
      function nr(t) {
        return !!(i9(t, !1) && t.includes(":")) && 2 === t.split(":").length;
      }
      function ni(t) {
        if (i9(t, !1))
          try {
      ...
      function nu(t) {
        let e = !0;
        return (
          i4(t) ? t.length && (e = t.every((t) => i9(t, !1))) : (e = !1), e
        );
      }
      function nf(t, e) {
        let r = null;
      ...
      function ng(t) {
        return !(i7(t) || !i9(t.method, !1));
      }
      function nv(t) {
        return !(
          i7(t) ||
          (i7(t.result) && i7(t.error)) ||
          !nt(t.id, !1) ||
          !i9(t.jsonrpc, !1)
        );
      }
      function nA(t) {
        return !(i7(t) || !i9(t.name, !1));
      }
      function ny(t, e) {
        return !(
          !nr(e) ||
      ...
      function nb(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                iZ(t.accounts).includes(e) && r.push(...t.methods);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      function nw(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                iZ(t.accounts).includes(e) && r.push(...t.events);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      Approved: ${u.toString()}`
        ...
        Approved: ${n.toString()}`
          ...
          s.forEach((t) => {
            i ||
              (Y(n[t].methods, o[t].methods)
                ? Y(n[t].events, o[t].events) ||
                  (i = i6(
                    "NON_CONFORMING_NAMESPACES",
      ...
      async function nN() {
        if (j() && "u" > typeof r.g && null != r.g && r.g.NetInfo) {
