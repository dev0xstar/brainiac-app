    ...
    40819: function (t, e, r) {
      ...
      (function () {
        ...
        g.versions.node
          ? (r = v)
          : i && (r = self);
        var n = !r.JS_SHA3_NO_COMMON_JS && b.exports,
        ...
        return (
          t.slice ||
            (t.slice = function () {
              ...
              return _(new Uint8Array(Array.prototype.slice.apply(t, e)));
            }),
          t
        );
      }
      ...
      function U(t) {
        ...
        if ("string" == typeof t || !R(t.length) || t.length < 0) return !1;
      ...
      function O(t, e) {
        for (
          "string" != typeof t
            ? (t = k(t))
            : D(t) || C.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
      ...
      !(function (t, e) {
        ...
        var m = function (t, e, r) {
          ...
          (u = (((o + (n >>> 13)) | 0) + (tS >>> 26)) | 0),
            ...
            (o = Math.imul(q, Q)),
            (i = (i + Math.imul(F, J)) | 0),
            (n = ((n = (n + Math.imul(F, Y)) | 0) + Math.imul(k, J)) | 0),
            (o = (o + Math.imul(k, Y)) | 0),
            (i = (i + Math.imul(U, K)) | 0),
          ...
          (u = (((o + (n >>> 13)) | 0) + (tB >>> 26)) | 0),
            ...
            (o = Math.imul(q, j)),
            (i = (i + Math.imul(F, V)) | 0),
            (n = ((n = (n + Math.imul(F, W)) | 0) + Math.imul(k, V)) | 0),
            (o = (o + Math.imul(k, W)) | 0),
            (i = (i + Math.imul(U, $)) | 0),
      ...
      class G {
        ...
        fromTwos(t) {
          return j(X(this).fromTwos(t));
        }
        toTwos(t) {
          return j(X(this).toTwos(t));
        }
        abs() {
          return "-" === this._hex[0] ? G.from(this._hex.substring(1)) : this;
        }
        add(t) {
          return j(X(this).add(X(t)));
        }
        sub(t) {
          return j(X(this).sub(X(t)));
        }
        div(t) {
          return (
            G.from(t).isZero() && V("division-by-zero", "div"),
            j(X(this).div(X(t)))
          );
        }
        mul(t) {
          return j(X(this).mul(X(t)));
        }
        mod(t) {
          let e = X(t);
          return e.isNeg() && V("division-by-zero", "mod"), j(X(this).umod(e));
        }
        pow(t) {
          let e = X(t);
          return e.isNeg() && V("negative-power", "pow"), j(X(this).pow(e));
        }
        and(t) {
          let e = X(t);
          return (
        ...
        static from(t) {
          ...
          if ("bigint" == typeof t) return G.from(t.toString());
          if (U(t)) return G.from(k(t));
          if (t) {
            if (t.toHexString) {
              let e = t.toHexString();
      ...
      function K(t) {
        ...
        if ("-" === t[0])
          return (
            "-" === (t = t.substring(1))[0] &&
              H.throwArgumentError("invalid hex", "value", t),
            "0x00" === (t = K(t)) ? t : "-" + t
          );
      ...
      function X(t) {
        let e = G.from(t).toHexString();
        return "-" === e[0]
          ? new Q("-" + e.substring(3), 16)
          : new Q(e.substring(2), 16);
      }
      function V(t, e, r) {
        let i = { fault: t, operation: e };
        return (
          null != r && (i.value = r), H.throwError(t, N.errors.NUMERIC_FAULT, i)
        );
      }
      let W = new N(L),
        Z = {},
      ...
      function te(t, e, r, i) {
        ...
        return (
          void 0 !== i && (n.value = i),
          W.throwError(t, N.errors.NUMERIC_FAULT, n)
        );
      }
      let tr = "0";
      for (; tr.length < 256; ) tr += tr;
      function ti(t) {
        if ("number" != typeof t)
          try {
            t = G.from(t).toNumber();
        ...
        return "number" == typeof t && t >= 0 && t <= 256 && !(t % 1)
          ? "1" + tr.substring(0, t)
          : W.throwArgumentError("invalid decimal size", "decimals", t);
      }
      function tn(t, e) {
        null == e && (e = 0);
        let r = ti(e),
      ...
      function to(t, e) {
        ...
        ("string" == typeof t && t.match(/^-?[0-9.]+$/)) ||
          W.throwArgumentError("invalid decimal value", "value", t);
        let i = "-" === t.substring(0, 1);
        i && (t = t.substring(1)),
          "." === t && W.throwArgumentError("missing value", "value", t);
        let n = t.split(".");
        n.length > 2 &&
          W.throwArgumentError("too many decimal points", "value", t);
        let o = n[0],
          s = n[1];
          ...
          if ("string" == typeof t) {
            if ("fixed" !== t) {
              if ("ufixed" === t) e = !1;
                ...
                n || W.throwArgumentError("invalid fixed format", "format", t),
                  (e = "u" !== n[1]),
                  (r = parseInt(n[2])),
                  (i = parseInt(n[3]));
              }
      ...
      class tf {
        ...
        addUnsafe(t) {
          ...
          return tf.fromValue(e.add(r), this.format.decimals, this.format);
        }
        subUnsafe(t) {
          this._checkFormat(t);
          let e = to(this._value, this.format.decimals),
            r = to(t._value, t.format.decimals);
          return tf.fromValue(e.sub(r), this.format.decimals, this.format);
        }
        mulUnsafe(t) {
          this._checkFormat(t);
          let e = to(this._value, this.format.decimals),
        ...
        floor() {
          ...
          1 === t.length && t.push("0");
          let e = tf.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (e = e.subUnsafe(th.toFormat(e.format))),
            e
          );
        }
        ceiling() {
          ...
          let e = tf.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (e = e.addUnsafe(th.toFormat(e.format))),
            e
          );
        }
        round(t) {
          ...
          if (
            (1 === e.length && e.push("0"),
            (t < 0 || t > 80 || t % 1) &&
              W.throwArgumentError("invalid decimal count", "decimals", t),
            e[1].length <= t)
          )
            return this;
          let r = tf.from("1" + tr.substring(0, t), this.format),
            i = tu.toFormat(this.format);
        ...
        toFormat(t) {
          return tf.fromString(this._value, t);
        }
        static fromValue(t, e, r) {
          ...
          return (
            ...
            null == e && (e = 0),
            null == r && (r = "fixed"),
            tf.fromString(tn(t, e), ts.from(r))
          );
        }
        ...
        static fromBytes(t, e) {
          null == e && (e = "fixed");
          let r = ts.from(e);
          if (T(t).length > r.width / 8) throw Error("overflow");
          let i = G.from(t);
          return (
        ...
        static from(t, e) {
          if ("string" == typeof t) return tf.fromString(t, e);
          if (U(t)) return tf.fromBytes(t, e);
          try {
            return tf.fromValue(t, 0, e);
          } catch (t) {
      ...
      tA(tb),
        ...
        (function (t) {
          ...
          for (;;) {
            let r = t() - 1;
            if (r < 0) break;
            e.push(tv(1 + t(), 1 + r, t).map((t) => [t[0], t.slice(1)]));
          }
          (function (t) {
            let e = {};
            for (let r = 0; r < t.length; r++) {
        ...
        new N("address/5.7.0");
      let ty = {};
      for (let t = 0; t < 10; t++) ty[String(t)] = String(t);
      for (let t = 0; t < 26; t++)
        ty[String.fromCharCode(65 + t)] = String(10 + t);
      ...
      tI.equal = function (t, e, r) {
        if (t != e) throw Error(r || "Assertion failed: " + t + " != " + e);
      };
      var tB = { exports: {} };
      "function" == typeof Object.create
        ? (tB.exports = function (t, e) {
            e &&
              ((t.super_ = e),
      ...
      (tS.inherits = tN),
        ...
        (tS.toHex = function (t) {
          for (var e = "", r = 0; r < t.length; r++) e += tx(t[r].toString(16));
          return e;
        }),
        (tS.htonl = tC),
        (tS.toHex32 = function (t, e) {
          for (var r = "", i = 0; i < t.length; i++) {
            var n = t[i];
            "little" === e && (n = tC(n)), (r += t_(n.toString(16)));
          }
          return r;
        }),
        (tS.zero2 = tx),
        ...
        (tS.sum64_4_hi = function (t, e, r, i, n, o, s, f) {
          var h,
            u = e;
          return (
            (t +
        ...
        (tS.sum64_4_lo = function (t, e, r, i, n, o, s, f) {
          return (e + i + o + f) >>> 0;
        }),
        (tS.sum64_5_hi = function (t, e, r, i, n, o, s, f, h, u) {
          var a,
            l = e;
          return (
            (t +
        ...
        (tS.sum64_5_lo = function (t, e, r, i, n, o, s, f, h, u) {
          return (e + i + o + f + u) >>> 0;
        }),
      ...
      (tR.BlockHash = tU),
        (tU.prototype.update = function (t, e) {
          if (
            ((t = tS.toArray(t, e)),
            this.pending
      ...
      (tD.ft_1 = function (t, e, r, i) {
        ...
        (tD.s0_256 = function (t) {
          return tF(t, 2) ^ tF(t, 13) ^ tF(t, 22);
        }),
        (tD.s1_256 = function (t) {
          return tF(t, 6) ^ tF(t, 11) ^ tF(t, 25);
        }),
        (tD.g0_256 = function (t) {
          return tF(t, 7) ^ tF(t, 18) ^ (t >>> 3);
        }),
        (tD.g1_256 = function (t) {
          return tF(t, 17) ^ tF(t, 19) ^ (t >>> 10);
        });
      var tO = tS.rotl32,
        tP = tS.sum32,
        tq = tS.sum32_5,
        tz = tD.ft_1,
        tL = tR.BlockHash,
        tQ = [1518500249, 1859775393, 2400959708, 3395469782];
      function tH() {
      ...
      tS.inherits(tH, tL),
        ...
        (tH.prototype._update = function (t, e) {
          ...
          for (i = 0; i < r.length; i++) {
            var u = ~~(i / 20),
              a = tq(tO(n, 5), tz(u, o, s, f), h, r[i], tQ[u]);
            (h = f), (f = s), (s = tO(o, 30)), (o = n), (n = a);
          }
          (this.h[0] = tP(this.h[0], n)),
            (this.h[1] = tP(this.h[1], o)),
            (this.h[2] = tP(this.h[2], s)),
            (this.h[3] = tP(this.h[3], f)),
      ...
      tS.inherits(t1, t$),
        ...
        (t1.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = tY(tZ(r[i - 2]), r[i - 7], tW(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            f = this.h[3],
            ...
            a = this.h[6],
            l = this.h[7];
          for (tI(this.k.length === r.length), i = 0; i < r.length; i++) {
            var d = tG(l, tV(h), tK(h, u, a), this.k[i], r[i]),
              c = tJ(tX(n), tj(n, o, s));
            (l = a),
              (a = u),
              (u = h),
      ...
      function ef() {
        if (!(this instanceof ef)) return new ef();
        es.call(this),
          (this.h = [
      ...
      tS.inherits(es, en),
        ...
        (es.hmacStrength = 192),
        (es.padLength = 128),
        (es.prototype._prepareBlock = function (t, e) {
          ...
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
              ...
              o = (function (t, e) {
                var r = t6(t, e, 19) ^ t6(e, t, 29) ^ t4(t, e, 6);
                return r < 0 && (r += 4294967296), r;
              })(r[i - 4], r[i - 3]),
              s = r[i - 14],
              f = r[i - 13],
              ...
              u = (function (t, e) {
                var r = t6(t, e, 1) ^ t6(t, e, 8) ^ t4(t, e, 7);
                return r < 0 && (r += 4294967296), r;
              })(r[i - 30], r[i - 29]),
              a = r[i - 32],
              l = r[i - 31];
            (r[i] = et(n, o, s, f, h, u, a, l)),
              (r[i + 1] = ee(n, o, s, f, h, u, a, l));
          }
        }),
        (es.prototype._update = function (t, e) {
          ...
          for (var b = 0; b < r.length; b += 2) {
            var y = A,
              ...
              C = r[b],
              x = r[b + 1],
              _ = er(y, w, M, E, S, I, B, N, C, x),
              R = ei(y, w, M, E, S, I, B, N, C, x);
            y = (function (t, e) {
        ...
        (ef.hmacStrength = 192),
        (ef.padLength = 128),
        (ef.prototype._digest = function (t) {
          return "hex" === t
      ...
      tS.inherits(ep, ec),
        ...
        (ep.prototype._update = function (t, e) {
          ...
          (m = el(this.h[1], n, a)),
            (this.h[1] = el(this.h[2], o, l)),
            (this.h[2] = el(this.h[3], s, f)),
            (this.h[3] = el(this.h[4], r, h)),
            (this.h[4] = el(this.h[0], i, u)),
            (this.h[0] = m);
        }),
      ...
      function ex(t, e) {
        (this.type = t),
          (this.p = new z(e.p, 16)),
          (this.red = e.prime ? z.red(e.prime) : z.mont(this.p)),
          (this.zero = new z(0).toRed(this.red)),
          (this.one = new z(1).toRed(this.red)),
          (this.two = new z(2).toRed(this.red)),
          (this.n = e.n && new z(e.n, 16)),
      ...
      (ex.prototype.point = function () {
        throw Error("Not implemented");
      }),
        (ex.prototype.validate = function () {
          throw Error("Not implemented");
        }),
        (ex.prototype._fixedNafMul = function (t, e) {
          eC(t.precomputed);
          var r = t._getDoubles(),
        ...
        (ex.prototype._wnafMul = function (t, e) {
          var r = 4,
            i = t._getNAFPoints(r);
          r = i.wnd;
          for (
            var n = i.points,
              o = eB(e, r, this._bitLength),
        ...
        (ex.prototype._wnafMulAdd = function (t, e, r, i, n) {
          var o,
            s,
            f,
            h = this._wnafT1,
        ...
        (ex.prototype.decodePoint = function (t, e) {
          t = eI.toArray(t, e);
        ...
        (e_.prototype.encode = function (t, e) {
          return eI.encode(this._encode(e), t);
        }),
      ...
      var eR = ew(function (t) {
        ...
        eU = eI.assert;
      function eT(t) {
        ex.call(this, "short", t),
          (this.a = new z(t.a, 16).toRed(this.red)),
          (this.b = new z(t.b, 16).toRed(this.red)),
      ...
      function eD(t, e, r, i) {
        ex.BasePoint.call(this, t, "affine"),
          null === e && null === r
      ...
      function eF(t, e, r, i) {
        ex.BasePoint.call(this, t, "jacobian"),
      ...
      eR(eT, ex),
        (eT.prototype._getEndomorphism = function (t) {
          if (!(!this.zeroA || !this.g || !this.n || 1 !== this.p.modn(3))) {
            if (t.beta) e = new z(t.beta, 16).toRed(this.red);
            else {
              var e,
                r,
                i,
            ...
            if (t.lambda) r = new z(t.lambda, 16);
            else {
              var o = this._getEndoRoots(this.n);
              0 === this.g.mul(o[0]).x.cmp(this.g.x.redMul(e))
                ? (r = o[0])
                : ((r = o[1]),
                  eU(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
            }
            return (
              (i = t.basis
                ? t.basis.map(function (t) {
                    return { a: new z(t.a, 16), b: new z(t.b, 16) };
                  })
        ...
        (eT.prototype._getEndoRoots = function (t) {
          var e = t === this.p ? this.red : z.mont(t),
            r = new z(2).toRed(e).redInvm(),
            i = r.redNeg(),
            n = new z(3).toRed(e).redNeg().redSqrt().redMul(r);
          return [i.redAdd(n).fromRed(), i.redSub(n).fromRed()];
        }),
        (eT.prototype._getEndoBasis = function (t) {
          for (
            var e,
              r,
              i,
        ...
        (eT.prototype._endoSplit = function (t) {
        ...
        (eT.prototype.pointFromX = function (t, e) {
          (t = new z(t, 16)).red || (t = t.toRed(this.red));
          var r = t
              .redSqr()
              .redMul(t)
        ...
        (eT.prototype.validate = function (t) {
          if (t.inf) return !0;
          var e = t.x,
            r = t.y,
            i = this.a.redMul(e),
        ...
        (eT.prototype._endoWnafMulAdd = function (t, e, r) {
          for (
        ...
        eR(eD, ex.BasePoint),
        (eT.prototype.point = function (t, e, r) {
          return new eD(this, t, e, r);
        }),
        (eT.prototype.pointFromJSON = function (t, e) {
        ...
        eR(eF, ex.BasePoint),
        (eT.prototype.jpoint = function (t, e, r) {
          return new eF(this, t, e, r);
        }),
        (eF.prototype.toP = function () {
        ...
        (eF.prototype.mixedAdd = function (t) {
        ...
        (eF.prototype._zeroDbl = function () {
          var t, e, r;
          if (this.zOne) {
            var i = this.x.redSqr(),
              n = this.y.redSqr(),
        ...
        (eF.prototype._threeDbl = function () {
          var t, e, r;
          if (this.zOne) {
            var i = this.x.redSqr(),
              n = this.y.redSqr(),
        ...
        (eF.prototype.mul = function (t, e) {
          return (t = new z(t, e)), this.curve._wnafMul(this, t);
        }),
        (eF.prototype.eq = function (t) {
        ...
        (eF.prototype.eqXToP = function (t) {
          var e = this.z.redSqr(),
        ...
        (eF.prototype.isInfinity = function () {
          return 0 === this.z.cmpn(0);
        });
      var ek = ew(function (t, e) {
          (e.base = ex), (e.short = eT), (e.mont = null), (e.edwards = null);
        }),
        eO = ew(function (t, e) {
          var r,
            i = eI.assert;
          function n(t) {
            "short" === t.type
              ? (this.curve = new ek.short(t))
              : "edwards" === t.type
              ? (this.curve = new ek.edwards(t))
              : (this.curve = new ek.mont(t)),
              (this.g = this.curve.g),
              (this.n = this.curve.n),
              (this.hash = t.hash),
      ...
      function eP(t) {
        ...
        (this.hash = t.hash),
          ...
          (this.K = null),
          (this.V = null);
        var e = eS.toArray(t.entropy, t.entropyEnc || "hex"),
          r = eS.toArray(t.nonce, t.nonceEnc || "hex"),
          i = eS.toArray(t.pers, t.persEnc || "hex");
        eM(
      ...
      (eP.prototype._init = function (t, e, r) {
        ...
        (eP.prototype.generate = function (t, e, r, i) {
          ...
          "string" != typeof e && ((i = r), (r = e), (e = null)),
            r && ((r = eS.toArray(r, i || "hex")), this._update(r));
          for (var n = []; n.length < t; )
            (this.V = this._hmac().update(this.V).digest()),
              (n = n.concat(this.V));
          var o = n.slice(0, t);
          return this._update(r), this._reseed++, eS.encode(o, e);
        });
      var eq = eI.assert;
      function ez(t, e) {
        (this.ec = t),
      ...
      (eQ.prototype._importDER = function (t, e) {
        ...
        (eQ.prototype.toDER = function (t) {
          ...
          var n = i.concat(r),
            o = [48];
          return eG(o, n.length), (o = o.concat(n)), eI.encode(o, t);
        });
      var eK = function () {
      ...
      (eX.prototype.keyPair = function (t) {
        ...
        (eX.prototype.genKeyPair = function (t) {
          ...
          for (
            var e = new eP({
              ...
              r = this.n.byteLength(),
              i = this.n.sub(new z(2));
            ;

          ) {
            var n = new z(e.generate(r));
        ...
        (eX.prototype.sign = function (t, e, r, i) {
          "object" == typeof r && ((i = r), (r = null)),
            ...
            (t = this._truncateToN(new z(t, 16)));
          for (
            var n = this.n.byteLength(),
              ...
              h = this.n.sub(new z(1)),
              u = 0;
            ;
            u++
          ) {
            var a = i.k ? i.k(u) : new z(f.generate(this.n.byteLength()));
            if (
        ...
        (eX.prototype.verify = function (t, e, r, i) {
          (t = this._truncateToN(new z(t, 16))), (r = this.keyFromPublic(r, i));
